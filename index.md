    ...
    <td>
      ...
      <section id="mistakes-were-made"><i>Mistakes were made:</i>
        <ul>
          ...
          <li><a href="languages/rust-design-mistakes-syntax">Rust's Design Mistakes</a></li>
          <li><a href="languages/rust-struct-initializer-mistake">Rust's Struct Initialization</a></li>
    ...
    <td>
      ...
      <section id="equality-and-identity"><i>Equality &amp; Identity:</i>
        <ol>
          ...
          <li><a href="languages/equality-and-identity-fixing-java">Fixing Java</a></li>
          <li><a href="languages/equality-and-identity-fixing-rust">Fixing Rust</a></li>
        </ol>
      </section>
